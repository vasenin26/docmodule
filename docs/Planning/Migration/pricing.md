...
- Стоимость сохраняется в AgentTask.cost, но не возвращается через API.
...
4. Интегрировать в AgentTaskManagerService: после подсчета токенов вызвать PricingService и сохранять cost.
5. Обновить AgentTaskResource: удалить/исключить cost из выходного формата.
...
8. Написать интеграционный тест на отсутствие экспозиции cost в API и корректность сохранения cost в БД: tests/Feature/AgentTaskCostApiTest.php (планируемый)
9. Обновление документации:
   - AgentTask.md
   - миграционные заметки в docs/Planning/Migration/pricing.md
