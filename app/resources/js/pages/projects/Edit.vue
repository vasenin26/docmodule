      ...
      <Card class="mt-6">
        ...
        <CardContent class="space-y-4">
          ...
          <div v-if="project.repositories && project.repositories.length > 0" class="space-y-2">
            ...
            >
              ...
              <Button
                ...
                :disabled="repositoryProcessing.value"
              >
                <Icon 
                  v-if="repositoryProcessing.value" 
                  name="loader-2" 
          ...
          <div v-else class="text-center py-8 text-muted-foreground">
            <Icon name="git-branch" class="h-8 w-8 mx-auto mb-2 text-muted-foreground/50" />
            ...
            <form @submit.prevent="addRepository" class="space-y-4">
              <div class="space-y-2">
                ...
                <div class="flex space-x-2">
                  ...
                  <Button 
                    type="submit" 
                    :disabled="repositoryForm.processing || !repositoryForm.url"
                  >
                    <Icon 
                      v-if="repositoryForm.processing" 
                      name="loader-2" 
                      class="mr-2 h-4 w-4 animate-spin" 
                    />
                    Добавить
...
const removeRepository = (repositoryId: number) => {
  if (confirm('Вы уверены, что хотите удалить этот репозиторий из проекта?')) {
    ...
    router.delete(route('projects.repositories.destroy', {
