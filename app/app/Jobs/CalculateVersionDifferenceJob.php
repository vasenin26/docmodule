...
class CalculateVersionDifferenceJob implements ShouldQueue
{
    ...
    public function handle(DiffGeneratorInterface $diffGenerator): void
    {
        ...
        // Create PageDiffDescription record
        $pageDiffDescription = PageDiffDescription::create([
            'page_id' => $newVersion->id,
        ...
        GenerateTaskDescriptionJob::dispatch($pageDiffDescription->id);
    }
