...
class OpenAIDescriptionGenerator implements TaskDescriptionGeneratorInterface
{
    ...
    {
        return "Ты - опытный разработчик, который создает краткие и информативные описания задач на основе изменений в коде. " .
               "Твоя задача - проанализировать diff между версиями кода и создать понятное описание того, что было изменено. " .
