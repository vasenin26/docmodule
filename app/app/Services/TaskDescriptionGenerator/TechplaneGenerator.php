...
class TechplaneGenerator implements TechplaneGeneratorInterface
{
    ...
    private function buildPrompt(string $taskDescription, array $attachedFiles = []): string
    {
        ...
        $prompt .= "Техплан должен быть:\n" .
            "- Детальным и пошаговым\n" .
            "- Понятным для разработчиков\n" .
            "- Техплан должен быть точным и однозначным \n" .
            "- Не должен содержать вариативных решений или предложений к выбору реализации \n" .
            "- На русском языке\n" .
            "- В формате Markdown с четкой структурой\n" .
            "- Содержать конкретные пути к файлам\n" .
            "- Описания причин добавление каждого шага в техплан\n" .
            "- Включать примеры кода где это необходимо\n\n" .

            $prompt .= "Для написания технического плана: \n" .
                "- Исследуй код с помощью утилит, найди файлы которые необходимо изменить и изучи их\n" .
                "- Исследуй документацию с помощью утилит, найди связанные с задачей страницы и изучи их\n" .
                "- Необходимо исследовать проект и предоставить в техплане все сведения необходимы для выполнения задачи\n" .
        ...
        $prompt .= "- Пошаговое руководство по реализации изменений в кодовой базе для выполнения задачи\n";
    ...
    private function getSystemPrompt(): string
    {
        $prompt = "Ты - технический архитектор, который создает детальные технические планы для разработчиков. " .
            ...
            "1. **Пошаговое руководство** - четкая последовательность действий для изменения кода\n" .
