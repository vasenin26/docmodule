...
```
Создай технический план на основе задачи. Исследуй код чтобы создать оптимальный технический план со всем подробностями необходимыми для реализации задачи. Технический план должен описывать порядок действий для того, чтобы выполнить все требования из задачи. Используй context7 чтобы понять как лучше применять пакеты и библиотеки используемые в проекте.
```